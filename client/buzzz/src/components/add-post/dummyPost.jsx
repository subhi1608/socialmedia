...
import {
	...
	dislikePost,
	flagPost,
} from "../../store/actions/like-dislike";

const DummyPost = ({ data }, setIsUserCommented) => {
	...
	// editing time
	const editedDate = format(new Date(createdAt), "dd-MMM HH:mm");
	...
	return (
		<div className={style.dummyPost} key={_id}>
			...
			<div className={style.addComment}>
				...
				<form action="" onSubmit={inputHandler} style={{ display: "flex" }}>
					<input
						type="text"
						name=""
						id=""
